...
MySQL - 5.6.27-log : Database - stap
*********************************************************************
*/
...
BEGIN
 ...
 WHERE   TABLE_SCHEMA = 'stap' AND TABLE_NAME = 'counter' AND COLUMN_NAME = 'TableName'); 
 IF _count = 0 THEN  ALTER TABLE counter ADD COLUMN  `TableName` varchar(100)  ; END IF; 
   
 SET _count = (  SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS  
 WHERE   TABLE_SCHEMA = 'stap' AND TABLE_NAME = 'counter' AND COLUMN_NAME = 'Counter'); 
