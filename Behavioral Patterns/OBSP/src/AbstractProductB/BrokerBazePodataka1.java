...
public class BrokerBazePodataka1 extends BrokerBazePodataka {
    ...
    Subject sub;
    GeneralDObject odoObserver;

    public BrokerBazePodataka1(Subject sub1) {
        sub = sub1;
    }
    ...
    public boolean executeUpdate(String upit, GeneralDObject odo) {
        Statement st = null;
    ...
    public boolean commitTransation() {
        try {
            conn.commit();
            sub.Notify(odoObserver.getPRKey());
    ...
    @Override
    public void closeConnectionObserver() {
        close(conn, null, null);
    }
