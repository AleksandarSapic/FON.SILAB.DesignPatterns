...
public class DKLet implements Serializable, GeneralDObject {
    ...
    public DKLet(DKLet state) {
        this.SifraLeta = state.SifraLeta;
        this.AvioKompanija = state.AvioKompanija;
        this.SifraAviona = state.SifraAviona;
        this.Pilot = state.Pilot;
        this.MestoUzletanja = state.MestoUzletanja;
        this.MestoSletanja = state.MestoSletanja;
        this.DatumLeta = state.DatumLeta;
    }
