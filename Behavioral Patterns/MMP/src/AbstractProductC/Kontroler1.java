...
public final class Kontroler1 extends Kontroler {
    ...
    void Povezi() {
        ...
        javax.swing.JButton Memento = (javax.swing.JButton) ef.getPanel().getMemento();
...
// Promenljivo!!!
    ...
    void undoMemento() {
        let = orig.setMemento(memento);
        this.napuniGrafickiObjekatIzDomenskogObjekta(let);
...
class OsluskivacPromeni implements ActionListener {
    ...
    @Override
    public void actionPerformed(ActionEvent e) {
        kon.orig = new Originator(kon.let);
